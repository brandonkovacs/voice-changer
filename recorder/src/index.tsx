...
const AppStateProviderWrapper = () => {
    ...
    if (!applicationSetting || !firstTach) {
        const clearSetting = () => {
            const result = window.confirm('Clear Settings');
            if (result) {
        ...
        return (
            <div className="front-container">
                ...
                <div className="front-description">
                    ...
                    <p className="front-description-strong">If you've tried using it and think it would be nice to treat us to a cup of coffee, please support us here.</p>
                    <p>
